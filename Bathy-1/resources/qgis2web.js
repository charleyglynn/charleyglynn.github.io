...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-4452779.631731, 4117799.027355, 2139927.967366, 12546999.748556], maxZoom: 6, minZoom: 1
    })
});


map.getView().fit([-4452779.631731, 4117799.027355, 2139927.967366, 12546999.748556], map.getSize());
