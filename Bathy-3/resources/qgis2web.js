...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-4201335.464423, 4110019.568364, 1993657.049252, 11317942.547229], maxZoom: 6, minZoom: 4
    })
});


map.getView().fit([-4201335.464423, 4110019.568364, 1993657.049252, 11317942.547229], map.getSize());
